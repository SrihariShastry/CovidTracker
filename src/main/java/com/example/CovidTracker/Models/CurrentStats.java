...
public class CurrentStats {
    ...
    public String getTotalTestsViral() {
        return totalTestsViral;
    }

    public void setTotalTestsViral(String totalTestsViral) {
    ...
    public String getPositiveCasesViral() {
        return positiveCasesViral;
    }

    public void setPositiveCasesViral(String positiveCasesViral) {
    ...
    public String getDeathProbable() {
        return deathProbable;
    }

    public void setDeathProbable(String deathProbable) {
    ...
    public String getTotalTestsAntibody() {
        return totalTestsAntibody;
    }

    public void setTotalTestsAntibody(String totalTestsAntibody) {
    ...
    public void setPositiveTestsAntibody(String positiveTestsAntibody) {
    ...
    public void setNegativeTestsAntibody(String negativeTestsAntibody) {
    ...
    public void setTotalTestsPeopleAntibody(String totalTestsPeopleAntibody) {
    ...
    public void setPositiveTestsPeopleAntibody(String positiveTestsPeopleAntibody) {
    ...
    public void setNegativeTestsPeopleAntibody(String negativeTestsPeopleAntibody) {
    ...
    public void setTotalTestsPeopleAntigen(String totalTestsPeopleAntigen) {
    ...
    public void setPositiveTestsPeopleAntigen(String positiveTestsPeopleAntigen) {
    ...
    public void setTotalTestsAntigen(String totalTestsAntigen) {
    ...
    public void setPositiveTestsAntigen(String positiveTestsAntigen) {
